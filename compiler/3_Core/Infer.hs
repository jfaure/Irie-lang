...
regeneralise ∷ Int → TCEnv s ()
regeneralise l = use wip ≫= \wip' → do -- regeneralise all let-bounds whose escaped vars are now resolved
...
--  _ → () <$ traceM "attempt to regenaralise non-let-bound"
